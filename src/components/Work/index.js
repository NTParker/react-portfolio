...
const Work = () => {
  return (
    <div name="skills" className="w-full h-screen background text-gray-300">
      {/* Container */}
      <div className="max-w-[1000px] bg-[#0a192f] mx-auto p-4 flex flex-col justify-center w-full">
        <div>
